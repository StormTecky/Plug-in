...
class ReportProcessingAlgorithm(QgsProcessingAlgorithm):
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        self.gain = self.parameterAsVectorLayer(parameters, self.GAIN, context)
    ...
    def getImageData(self):
        ...
        return {
            ...
            '{GAIN}': [self.systemService.filterByFileName(mapsPath, ['11_Yield_gain_using_T2']), 3.13],
